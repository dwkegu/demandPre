...
if __name__ == '__main__':
    #[batch, T, d, h, w c]
    model = STC_Lstm([None, 7, 96, 32, 32, 1], [None, 1, 32, 32, 1], learning_rate=0.0004, name="B96-STC=LSTM")
    ...
    dataset = STC_Provider(config.dataset_path + "/nyt_d_map.npy", 7, 16, 96, 1, [14640, 1440, 1440], offset=False)
