...
if __name__ == '__main__':
    #[batch, T, d, h, w c]
    model = STC_Lstm([None, 28, 24, 32, 32, 2], [None, 1, 32, 32, 1], learning_rate=0.0002)
    ...
    dataset = STC_Provider(config.dataset_path + "/nyt_d_map.mat", 28, 16, 24, 1, [43824, 8760, 8760])
