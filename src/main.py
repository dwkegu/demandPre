...
if __name__ == '__main__':
    # [batch, T, d, h, w c]
    nyt_config = {'input_shape': [None, 28, 24, 64, 64, 1], 'output_shape': [None, 1, 64, 64, 1],
                  'model_name': "nyc-taxi-STC-LSTM-28-step", 't_length': 28, 'T': 24, 'splits':[14640, 1440, 1440], 'offset':False}
