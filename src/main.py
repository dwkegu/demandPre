...
if __name__ == '__main__':
    #[batch, T, d, h, w c]
    model = STC_Lstm([None, 28, 24, 64, 64, 1], [None, 1, 64, 64, 1], learning_rate=0.0002, name="B96-STC=LSTM")
    ...
    dataset = STC_Provider(config.dataset_path + "/nyt_d_map.mat", 28, 24, 24, 1, [43824, 8760, 8760], offset=False)
