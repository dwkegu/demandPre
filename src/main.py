...
if __name__ == '__main__':
    #[batch, T, d, h, w c]
    model = STC_Lstm([None, 14, 24, 16, 8, 1], [None, 1, 16, 8, 1], learning_rate=0.0004)
    ...
    dataset = STC_Provider(filenames=files[0], t_length=14, batch_size=16, input_size=24, output_size=1, splits=[3804, 348, 240])
