...
class CubeCNN(Model):
    ...
    def build(self,):
        with tf.name_scope("layer1"):
            net = self.block_A(self._inputs, [[8, 8, 8], [12, 12], [24, 24]], activation=tf.nn.relu, name="layer1_blockA")
        with tf.name_scope("layer2"):
            net = self.block_B(net, [[[5, 5, 44, 22], [1, 1, 1, 1], 22], [[3, 3, 22, 11], [1, 1, 1, 1], 11], [[3, 3, 11, 1], [1, 1, 1, 1], 1]],
