...
class CubeCNN(Model):
    ...
    def build(self,):
        ...
        with tf.name_scope("layer2"):
            net = self.block_B(net, [[[5, 5, 36, 18], [1, 1, 1, 1], 18], [[3, 3, 18, 10], [1, 1, 1, 1], 10], [[3, 3, 10, 1], [1, 1, 1, 1], 1]],
        ...
        train_op = tf.train.RMSPropOptimizer(0.0002).minimize(self._loss, global_step=global_steps)
